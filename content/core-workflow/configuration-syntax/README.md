...
for a more detailed look into the HCL syntax.
...
*/
resource "aws_instance" "app" {
  // This is a single-line comment using the non-preferred `//` syntax.
  ami           = "ami-0cff7528ff583bf9a"
  instance_type = "t3.micro"

  # This is a single-line comment using the preferred `#` syntax.
  metadata_options {
    http_endpoint = "enabled"
  }
}
